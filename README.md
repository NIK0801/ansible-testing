...
```shell
nikita.dragomir@dragomir-pc:~/playbook/clickhouse-role$ molecule test -s centos_7
---
dependency:
  name: galaxy
driver:
...
```shell
nikita.dragomir@dragomir-pc:~/playbook/vector-role$ molecule init scenario --driver-name docker
INFO     Initializing new scenario default...
INFO     Initialized scenario in /home/nikita.dragomir/playbook/vector-role/molecule/default successfully.
...
```shell
nikita.dragomir@dragomir-pc:~/playbook/vector-role$ molecule test -s centos
...
INFO     Set ANSIBLE_LIBRARY=/home/nikita.dragomir/.cache/ansible-compat/f5bcd7/modules:/home/nikita.dragomir/.ansible/plugins/modules:/usr/share/ansible/plugins/modules
INFO     Set ANSIBLE_COLLECTIONS_PATH=/home/nikita.dragomir/.cache/ansible-compat/f5bcd7/collections:/home/nikita.dragomir/.ansible/collections:/usr/share/ansible/collections
INFO     Set ANSIBLE_ROLES_PATH=/home/nikita.dragomir/.cache/ansible-compat/f5bcd7/roles:/home/nikita.dragomir/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
...
playbook: /home/nikita.dragomir/playbook/vector-role/molecule/centos/converge.yml
...
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '742571473783.40940', 'results_file': '/home/nikita.dragomir/.ansible_async/742571473783.40940', 'changed': True, 'item': {'image': 'docker.io/pycontribs/centos:7', 'name': 'instance', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
...
<details>
    <summary>Вывод Ubuntu</summary>

```shell
nikita.dragomir@dragomir-pc:~/playbook/vector-role$ molecule test -s ubuntu
...
playbook: /home/nikita.dragomir/playbook/vector-role/molecule/ubuntu/converge.yml
...
TASK [Wait for instance(s) creation to complete] *******************************
FAILED - RETRYING: [localhost]: Wait for instance(s) creation to complete (300 retries left).
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '298355433055.33414', 'results_file': '/home/nikita.dragomir/.ansible_async/298355433055.33414', 'changed': True, 'item': {'image': 'pycontribs/ubuntu:latest', 'name': 'instance', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
...
```shell
nikita.dragomir@dragomir-pc:~$ docker run --privileged=True -v ~/playbook/vector-role:/opt/vector-role -w /opt/vector-role -it aragast/netology:latest /bin/bash
```

3. Внутри контейнера выполните команду `tox`, посмотрите на вывод.

```shell
[root@c3419477r22g vector-role]# cat /etc/containers/containers.conf
[containers]
userns="host"
ipcns="host"
cgroupns="host"
...
```shell
[root@c3419477r22g vector-role]# cat tox.ini
[tox]
minversion = 1.8
